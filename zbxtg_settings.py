...
tg_key = "1306164119:AAFz9B8ATfyYlivYaJj92y1xv2tmUDe6bPI"  # telegram bot api key

zbx_tg_prefix = "zbxtg"  # variable for separating text from script info

#zbx_tg_tmp_dir = "/var/tmp/" + zbx_tg_prefix  # directory for saving caches, uids, cookies, etc.
zbx_tg_tmp_dir = "/var/lib/zabbix" + zbx_tg_prefix  # directory for saving caches, uids, cookies, etc.
...
zbx_server = "http://10.131.2.18/"  # zabbix server full url
zbx_api_user = "Admin"
zbx_api_pass = "j8PQc2k"
